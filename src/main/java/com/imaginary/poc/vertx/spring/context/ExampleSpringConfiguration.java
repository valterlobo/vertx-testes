package com.imaginary.poc.vertx.spring.context;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.imaginary.poc.vertx.spring.repository"})
@PropertySource(value = { "classpath:application.properties" })
@ComponentScan("com.imaginary.poc.vertx.spring.service")
public class ExampleSpringConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
    ...
    factory.setPackagesToScan("com.imaginary.poc.vertx.spring.entity");
